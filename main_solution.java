// Practicum 5 (Expression Evaluation) Solution
...
class Main {
  public static void main(String[] args) {
    ...
    year = 2023;
    // CHANGE: Replaced <operator> with /
    two_digit_century = 2023 / 100;  // should be assigned 20 (int)
    // CHANGE: Replaced <operator> with % (mod operator)
    ...
    // CHANGE: Added (int)(        )
    var7 = (int)(var4 + var5);  // var7 should be 15 (int)
    
    // operator precedence
    // CHANGE: 2 + 3 changed to (2 + 3)
    ...
    var11 = -10;
    var12 = false;
    // CHANGE: !var10 > 0 changed to !(var10 > 0)
    
    // Without the parenthese the ! (not) operator is
    // first applied to int variable var10, which
    // does not make sense. This is because the !
    // operator has higher precedence than the > operator.
    var13 = !(var10 > 0);  // var13 should be true
    // CHANGE: Change var12 to !var12
    var14 = !var12 && (var10 > -1 || var10 > var11);  // var14 should be true

    // NOTE: No change needed. Evaluated as:
    //       var10 == (-1 && var12) || var10 > var11;
    //       which is true.
